...
class DataManager:
    ...
    def read_data_format_fixed(self, sample):
        context_parsed, sequence_parsed = \
                    tf.io.parse_single_sequence_example(sample,
                                                     context_features={
                                                      'sequence_length': tf.io.FixedLenFeature([], dtype=tf.int64),
                                                      'base_audio_wav': tf.io.FixedLenFeature([self.num_audio_samples], dtype=tf.float32),
                                                      'other_audio_wav': tf.io.FixedLenFeature([self.num_audio_samples], dtype=tf.float32),
                                                      'mix_audio_wav': tf.io.FixedLenFeature([self.num_audio_samples], dtype=tf.float32),
                                                     ...
                                                     sequence_features={
                                                      'tbm': tf.io.FixedLenSequenceFeature([self.single_audio_frame_size], dtype=tf.float32),
                                                      'video_features': tf.io.FixedLenSequenceFeature([self.single_video_frame_size], dtype=tf.float32),
                                                      'mixed_spectrogram': tf.io.FixedLenSequenceFeature([self.single_audio_frame_size], dtype=tf.float32)
                                                      })

        #sequence_parsed['mixed_spectrogram'],
#        return tf.to_int32(context_parsed['sequence_length']), \
        return tf.cast(context_parsed['sequence_length'],tf.int32),\
        ...
        context_parsed, sequence_parsed = \
                    tf.io.parse_single_sequence_example(sample,
                                                     ...
                                                     sequence_features={
                                                      ...
                                                      'video_features': tf.io.FixedLenSequenceFeature([self.single_video_frame_size], dtype=tf.float32),
                                                      'mixed_spectrogram': tf.io.FixedLenSequenceFeature([self.single_audio_frame_size], dtype=tf.float32),
                                                      'base_audio_wav': tf.io.FixedLenSequenceFeature([], dtype=tf.float32),
                                                      'other_audio_wav': tf.io.FixedLenSequenceFeature([], dtype=tf.float32),
                                                      'mix_audio_wav': tf.io.FixedLenSequenceFeature([], dtype=tf.float32),
                                                      'base_audio_path': tf.io.FixedLenSequenceFeature([], dtype=tf.int64),
                                                      'other_audio_path': tf.io.FixedLenSequenceFeature([], dtype=tf.int64),
                                                      'mix_audio_path': tf.io.FixedLenSequenceFeature([], dtype=tf.int64)
                                                     })
